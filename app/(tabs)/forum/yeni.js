  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.bg.base }}>
      <View style={[styles.nav, { paddingTop: insets.top + 6, borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.ti, { color: colors.text.primary }]} numberOfLines={1}>Yeni gönderi</Text>
        <Pressable onPress={submit} disabled={!valid || create.isPending}
          ...
          <Text style={styles.subT} numberOfLines={1}>Paylaş</Text>
        </Pressable>
      </View>
...
const styles = StyleSheet.create({
  ...
  ti:  { flex: 1, fontSize: 14, fontFamily: fonts.extrabold, marginLeft: 12 },
  sub: { flexShrink: 0, marginLeft: 12, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 6 },
